...
<head>
    ...
    <style>
        ...
        .actor-details-container h2 {
            font-size: 28px;
            margin-bottom: 15px;
        }
        .actor-details-container p {
            font-size: 18px;
            margin-bottom: 10px;
        }
        .actor-details-container .description {
            margin-top: 20px;
            font-size: 16px;
            color: #b0b0b0;
        }
        ...
        .movie-box .movie-details h2 {
            font-size: 20px;
            margin: 0 0 10px;
        }
        .movie-box .movie-details p {
            margin: 0;
            font-size: 14px;
            color: #b0b0b0;
        }
...
<div class="actor-details-container">
    ...
    $imageUrl = "https://picsum.photos/400/500?random={$actor->actor_id}_{$randomNumber}";
    @endphp
